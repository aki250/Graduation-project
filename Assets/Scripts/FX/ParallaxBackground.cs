...
{
    private GameObject cam;  //主摄像机引用

    [SerializeField] private float parallaxEffect;  //控制背景滚动速度

    private float xPosition;  //x坐标
    private float length;     //背景宽度，用于计算视差平移
    ...
    private void Start()
    {
        ...
        //获取背景图像宽度，使用SpriteRenderer来取得背景
